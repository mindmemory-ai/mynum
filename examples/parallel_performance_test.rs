...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🚀 MyNum 并行乘法性能测试");
    println!("{}", "=".repeat(60));

    // 测试不同大小的数字
    let test_cases = vec![
        ("小数字 (64位)", 
         Mpz::from_str("123456789012345678", 10)?,
         Mpz::from_str("987654321098765432", 10)?),

        ("中等数字 (256位)",
         Mpz::from_str("12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890", 10)?,
         Mpz::from_str("98765432109876543210987654321098765432109876543210987654321098765432109876543210987654321098765432109876543210987654321098765432109876543210987654321098765432109876543210987654321098765432109876543210", 10)?),
    ...
    println!("   • 对于大数计算，启用并行模式");
    println!("   • 根据实际性能测试调整并行阈值");
    println!("   • 监控内存使用，并行算法需要更多内存");
